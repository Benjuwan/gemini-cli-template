# Branch / Commit / PR Guidelines for AI

> このガイドラインは、AIがブランチ作成・コミット・PR作成を自動実行する際に従うべき規約です。
> プロジェクトのルートに置いたAIの行動指針・憲法（例：`/GEMINI.md`, `/AGENTS.md`）から参照してください。
